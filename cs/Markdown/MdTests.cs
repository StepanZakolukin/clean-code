...
internal class MdTests
{
    ...
    [TestCase("_выделяетсяТегом_", "<em>выделяетсяТегом</em>")]
    ...
    [TestCase("полужирное выделение в ра_зных сл_овах не работает", "полужирное выделение в ра_зных сл_овах не работает")]
